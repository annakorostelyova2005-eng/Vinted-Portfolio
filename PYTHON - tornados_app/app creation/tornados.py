...
if st.session_state.get("clear_inputs_tab4", False):
    st.session_state["input_1_tab4"] = ""
    st.session_state["input_2_tab4"] = ""
    st.session_state["input_3_tab4"] = "F0"
    st.session_state["prediction_tab4"] = ""
    st.session_state["clear_inputs_tab4"] = False
...
if st.session_state.get("clear_inputs_tab5", False):
    st.session_state["input_1_tab5"] = ""
    st.session_state["input_2_tab5"] = ""
    st.session_state["input_3_tab5"] = ""
    st.session_state["input_4_tab5"] = ""
    st.session_state["input_5_tab5"] = "Alabama"
    st.session_state["input_6_tab5"] = "F0"
    st.session_state["clear_inputs_tab5"] = False
...
if st.session_state.get("clear_inputs_tab6", False):
    st.session_state["input_1_tab6"] = ""
    st.session_state["input_2_tab6"] = ""
    st.session_state["input_3_tab6"] = ""
    st.session_state["input_4_tab6"] = ""
    st.session_state["input_5_tab6"] = "January"
    st.session_state["input_6_tab6"] = "F0"
    st.session_state["input_7_tab6"] = "Alabama"
    st.session_state["input_8_tab6"] = ""
    st.session_state["clear_inputs_tab6"] = False
...
if st.session_state.get("clear_inputs_tab7", False):
    st.session_state["input_1_tab7"] = ""
    st.session_state["input_2_tab7"] = ""
    st.session_state["input_3_tab7"] = ""
    st.session_state["input_4_tab7"] = "January"
    st.session_state["clear_inputs_tab7"] = False
